...
Movie.create(
    ...
    movie_url: "https://www.imdb.com/video/vi3058222105/?listId=ls053181649&ref_=ext_shr_lnk",
    user_id: nil,
...
Movie.create(
    ...
    movie_url: "https://www.imdb.com/video/vi2571682841/?listId=ls053181649&ref_=ext_shr_lnk",
    user_id: nil,
    originally_fetched: true
)
...
Movie.create(
    ...
    movie_url: "https://www.imdb.com/video/vi3678651417/?listId=ls053181649&ref_=ext_shr_lnk",
    user_id: nil,
    originally_fetched: true
)
...
Movie.create(
    ...
    movie_url: "https://www.imdb.com/video/vi2101789721/?listId=ls053181649&ref_=ext_shr_lnk",
    user_id: nil,
    originally_fetched: true
)
...
Movie.create(
    ...
    ",
    movie_url: "https://www.imdb.com/video/vi1314702361/?listId=ls053181649&ref_=ext_shr_lnk",
    user_id: nil,
    originally_fetched: true
)
...
Movie.create(
    title: "TKillers of the Flower Moon",
    year: 2023,
    ...
    movie_url: "https://www.imdb.com/video/vi3629499417/?listId=ls053181649&ref_=ext_shr_lnk",
    user_id: nil,
    originally_fetched: true
)
...
Movie.create(
    ...
    movie_url: "https://www.imdb.com/video/vi1028899865/?listId=ls053181649&ref_=ext_shr_lnk",
    user_id: nil,
    originally_fetched: true
)
...
Movie.create(
    ...
    movie_url: "https://www.imdb.com/video/vi1599390745/?listId=ls053181649&ref_=ext_shr_lnk",
    user_id: nil,
    originally_fetched: true
)
...
Movie.create(
    ...
    movie_url: "https://www.imdb.com/video/vi3510879257/?listId=ls053181649&ref_=ext_shr_lnk.",
    user_id: nil,
    originally_fetched: true
)
